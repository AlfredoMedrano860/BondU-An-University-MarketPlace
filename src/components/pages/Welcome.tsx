...
import cara from "../../assets/imgs/CaraMascota.webp";
import brazos from "../../assets/imgs/BrazosMascota.webp";
 ...
 *
 * @param onLogin - Navega a {@link Login}.
 * @param onExit - Vuelve a la pantalla de carga.
 */
function Welcome({ onLogin, onExit }: WelcomeProps) {
