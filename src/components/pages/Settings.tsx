...
interface SettingsProps {
  ...
  onLogout: () => void;
  /** Se ejecuta al guardar exitosamente la preferencia de notificaciones. */
 ...
 */
function Settings({ onNavigate, currentUser, onLogout, onNotificationsChange }: SettingsProps) {
  const { t } = useTranslation();
  const { notifications, dialog, setDialog, handleConfirmLogout, handleConfirmDelete, toggleLanguage, handleDarkMode, handleNotificationsToggle } = useSettings(currentUser, onLogout, onNotificationsChange);
