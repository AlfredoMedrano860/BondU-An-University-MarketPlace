...
// ESTE COMPONENTE NOS LO DIO EL PROFE, MEJOR LEER LA DOCUMENTACIÓN OFICIAL
// https://www.radix-ui.com/primitives/docs/components/accordion

/**
 * Trigger reutilizable para el acordeón de Radix UI.
 * Muestra un ícono, el texto del trigger y un chevron animado.
 *
...
/**
 * Acordeón de la sección "Sobre Nosotros" en ajustes.
 *
 * Muestra la misión, visión y equipo de desarrollo del proyecto.
 * El contenido se obtiene de {@link mision}, {@link vision} y {@link developers}.
 * Usa el componente Accordion de Radix UI con animación de apertura y cierre.
 */
      ...
      <Accordion.Item value="about">
        ...
        <Accordion.Content className="accordion-content border-t border-beige">
          <div className="px-5 pb-5 flex flex-col gap-5 pt-4">
            ...
            {/* El Equipo ── agregar avatares en About.ts cuando estén disponibles */}
            <div className="border-t border-beige pt-4">
